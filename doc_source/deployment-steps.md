...
**A port for your replacement task set**  
 During your Amazon ECS deployment, your load balancer directs traffic to this *port* on the container specified in your AWS CodeDeploy application's AppSpec file\. You specify the port in your AWS CodeDeploy application's AppSpec file\. For more information, see [ AppSpec 'resources' Section for Amazon ECS Deployments ](reference-appspec-file-structure-resources.md#reference-appspec-file-structure-resources-ecs)\. 
