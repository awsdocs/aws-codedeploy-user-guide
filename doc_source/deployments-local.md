...
+ Install version 1\.0\.1\.1352 or later of the CodeDeploy agent\. For information, see [Install or Reinstall the CodeDeploy Agent](codedeploy-agent-operations-install.md)\.
